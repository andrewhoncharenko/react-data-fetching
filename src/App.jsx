...
function App() {
  ...
  useEffect(() => {
    setIsFetching(true);
    fetchUserPlaces().then((placesData) => {
  ...
  function handleSelectPlace(selectedPlace) {
    ...
    updateUserPlaces([selectedPlace, ...userPlaces]).catch((error) => {
  ...
  const handleRemovePlace = useCallback(async function handleRemovePlace() {
    ...
    updateUserPlaces(userPlaces.filter((place) => place.id !== selectedPlace.current.id)).catch((error) => {
      setUserPlaces(userPlaces);
